        ...
        <div class="aside_content">
            <div class="aside_content_main">
                ...
                <div class="user_management_sub" style="display: none;">
                    ...
                    <div class="user_management_sub2">
                        <img class="activeIcon"  src="../resources/images/Remove_light.png" alt="remove">
                        신고 관리
                    </div>
                </div>
            </div>
            ...
            <div class="row_main2_sub">
                ...
                <div class="row_main2_sub_tableBox">
                    <table class="row_main2_sub_table">
                        <colgroup>
                            <col style="width: 4.52%">
                            <col style="width: 81.68%">
                            ...
                            <tr>
                                ...
                                <th class="boxth">
                                    ...
                                    <div class="sort_keyword">
                                        <img src="../resources/images/arrow_upward.png" alt="uparrow">
                                        <img src="../resources/images/arrow_downward.png" alt="downarrow">
                                    </div>
                                </th>
                                <th>등록일</th>
                                <th>삭제</th>
