...
<div id="containerM">
	...
	<div class="partner_myreview_detail_inner">
		...
		<div class="right-align">
			<div id="res_btn" class="partner_myreview_detail_inner_respon">
				답변달기
				<img src="resources\images\Group 8739.png" alt="8739">	
			</div>
		</div>
	</div>
</div>
<div id="respon_box">
	<form class="partner_myreview_respon_form" action="#" method="post">
